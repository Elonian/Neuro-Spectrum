"""Train SimpleLSTM from current and past x samples."""
...
def main() -> None:
    ...
    p = argparse.ArgumentParser(description="Train SimpleLSTM with DataLoader")
    ...
    p.add_argument("--num-layers", type=int, default=1, help="stacked LSTM depth (nn.LSTM num_layers)")
    p.add_argument("--hidden", type=int, default=64, help="LSTM hidden_size")
    ...
    model = SimpleLSTM(L=args.L, num_layers=args.num_layers, hidden=args.hidden)
